...
import com.example.protodatastore.users.api.models.Age
...
class UsersViewModelTest {
    ...
    fun `should get users and emit success state`() = runTest {
        ...
        val mockUser1 = User(gender = "male", name = UserName(first = "Padrino", last = "Taj"), dob = Age(age = 49))
        val mockUser2 = User(gender = "male", name = UserName(first = "Bop", last = "Alvarez"), dob = Age(age = 35))
        val mockUser3 = User(gender = "female", name = UserName(first = "Lisa", last = "Lopez"), dob = Age(age = 22))
